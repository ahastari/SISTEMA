...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-2">
    <div>
        <h3 class="mb-0 fw-bold text-body">Editar Ficha del Producto</h3>
        <p class="text-secondary small mb-0">Modificar la información técnica, clasificación o costos del artículo</p>
    </div>
    ...
    <div class="row g-3">
                ...
                <div class="card-body p-3">
                    <div class="row g-2">
                        ...
                        <div class="col-12 col-md-6 mb-2">
                            <label class="form-label small fw-semibold text-secondary">Código Interno</label>
                            <input type="text" class="form-control form-control-sm bg-body-tertiary text-secondary" value="{{ $equipo->codigo }}" readonly disabled>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="descripcion" class="form-control form-control-sm bg-body text-body" rows="3">{{ old('descripcion', $equipo->descripcion) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-3" style="background: var(--bs-body-bg); border: 1px solid var(--bs-border-color) !important;">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-12 col-md-6 mb-2" id="container_precio_venta" style="{{ $isVenta ? '' : 'display: none;' }}">
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="form-check form-switch mb-4 ms-1">
                <input class="form-check-input" type="checkbox" name="activo" id="activo" value="1" {{ old('activo', $equipo->activo) ? 'checked' : '' }} style="transform: scale(1.3);">
                <label class="form-check-label ms-2 fw-bold text-body" for="activo">Producto Activo y Visible</label>
            </div>

            <button type="submit" class="btn btn-warning fw-bold w-100 py-2 shadow-sm rounded-3 text-dark"><i class="bi bi-pencil-square me-1"></i> Actualizar Producto</button>
        </div>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    // Selección al enfocar inputs de número
    ...
    // Control dinámico de Renta / Venta
