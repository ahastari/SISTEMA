    ...
    <div class="row">
        <div class="col-12 col-lg-8">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            <label class="form-label text-muted">Código Interno (Auto-generado)</label>
                            <input type="text" class="form-control bg-light" value="Se asignará automáticamente al guardar" disabled>
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <small class="text-muted">Si el producto tiene código de barras, escanéalo aquí.</small>
                        </div>
                        
                        <div class="col-12">
                            <label class="form-label fw-bold">Descripción detallada</label>
                            <textarea name="descripcion" class="form-control" rows="3" placeholder="Medidas, peso, marca, modelo, etc.">{{ old('descripcion') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3" id="container_precio_renta">
                        ...
                        <div class="col-12 col-md-6 mb-3" id="container_precio_venta" style="display: none;">
        ...
        <div class="col-12 col-lg-4">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-outline-primary d-flex align-items-center gap-1" data-bs-toggle="modal" data-bs-target="#modalCategoria" title="Añadir Nueva Categoría">
                                <i class="bi bi-plus-lg"></i> <span class="d-none d-md-inline">Nueva</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button type="button" class="btn btn-outline-primary d-flex align-items-center gap-1" data-bs-toggle="modal" data-bs-target="#modalUnidad" title="Añadir Nueva Unidad">
                                <i class="bi bi-plus-lg"></i> <span class="d-none d-md-inline">Nueva</span>
                            </button>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div id="dropzone" class="w-100 p-4 text-center border rounded bg-light" style="border: 2px dashed #0d6efd !important; cursor: pointer; transition: all 0.3s;">
                        ...
                        <div id="dropzone-text">
                            ...
                            <h6 class="text-secondary mb-0">Seleccionar o soltar imagen</h6>
                        </div>
                        <div id="image-preview-container" style="display: none; position: relative;">
                            <img id="image-preview" src="" alt="Vista previa" class="img-fluid rounded shadow-sm" style="max-height: 150px;">
            ...
            <div class="form-check form-switch mb-4 ms-1">
                <input class="form-check-input" type="checkbox" name="activo" id="activo" {{ old('activo', true) ? 'checked' : '' }} style="transform: scale(1.3);">
                <label class="form-check-label ms-2 fw-bold" for="activo">Producto Activo y Visible</label>
            </div>

            <button type="submit" class="btn btn-primary btn-lg w-100 shadow-sm"><i class="bi bi-save me-2"></i> Guardar Producto</button>
        </div>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (modalCategoriaEl) {
        modalCategoriaEl.addEventListener('hidden.bs.modal', function() {
            formCategoria.reset();
            document.querySelector('#formCategoria input[name="nombre"]')?.focus();
        });
    }
    ...
    if (modalUnidadEl) {
        modalUnidadEl.addEventListener('hidden.bs.modal', function() {
            formUnidad.reset();
            document.querySelector('#formUnidad input[name="nombre"]')?.focus();
        });
    }
});
</script>
